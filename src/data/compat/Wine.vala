...
namespace GameManager.Data.Compat
{
	public class Wine: CompatTool
	{
		...
		{
			return installed && runnable != null && ((runnable is Game && (runnable is GameManager.Data.Sources.User.UserGame || Platform.WINDOWS in runnable.platforms)) || runnable is Emulator);
		}
