# GameManager [![Build status](https://ci.appveyor.com/api/projects/status/cgw5hc4kos4uvmy9/branch/master?svg=true)](https://ci.appveyor.com/project/tkashkin/gamemanager/branch/master) [![Translation status](https://hosted.weblate.org/widgets/gamemanager/-/translations/svg-badge.svg)](https://hosted.weblate.org/engage/gamemanager/?utm_source=widget)
Mirrors: [GitHub](https://github.com/tkashkin/GameManager), [codeberg.org](https://codeberg.org/tkashkin/GameManager), [repo.or.cz](https://repo.or.cz/GameManager.git), [git.froggi.es](https://git.froggi.es/tkashkin/gamemanager)
...
GameManager also has features like:
